...
(* OASIS_START *)
(* DO NOT EDIT (digest: 253f87bd239d5c3c571d38a1f833354b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://www.sinsireader.com";
          synopsis = "RSS Feed Reader";
          description = Some [OASISText.Para "A web-based RSS Reader"];
          categories = [];
            ...
            [
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/datodev/sinsi";
                      src_repo_browser =
                        Some "https://github.com/datodev/sinsi";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "fñ®ÚP÷+\131câ6~ÚÐÃÍ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

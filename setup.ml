...
(* OASIS_START *)
(* DO NOT EDIT (digest: dba5f2f2953e4056e7a0a7ec28caa5d2) *)
(*
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Sean Grove <sean@cardcat.com>"];
          homepage = Some "http://www.cardcat.com";
          synopsis = "A site for buying giftcards";
          description = Some [OASISText.Para "A site for buying giftcards"];
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dexica/cardcat.git";
                      src_repo_browser =
                        Some "https://github.com/dexica/cardcat";
